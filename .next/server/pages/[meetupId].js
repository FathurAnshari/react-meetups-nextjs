...
const getStaticPaths = async ()=>{
    const client = await external_mongodb_.MongoClient.connect("mongodb+srv://fathuranshari:E0PFo1PNiuS686fW@cluster0.z0txn.mongodb.net/meetups?retryWrites=true&w=majority");
    const db = client.db();
